export default function Pricecomponent() {
        ...
        <>
            <div>
                <div className="container max-w-full mx-auto py-24 px-6">
                    ...
                    <div
                        className="h-1 mx-auto bg-emerald-800 w-24 opacity-75 mt-4 rounded"
                    ></div>
                                    ...
                                    <div className="flex flex-wrap mt-3 px-6">
                                        <ul>
                                            ...
                                            <li className="flex items-center">
                                                ...
                                                <span className="text-gray-700 text-lg ml-3">Speed Support</span>
                                            </li>
                                        </ul>
                                    </div>
	...
	bg-gray-300 w-full text-grey-800 rounded-lg 
	px-6 py-3 block shadow-xl hover:bg-emerald-500 hover:text-white"
                                        >
                                            Select
                                        </button>
                                    </div>
                            ...
                            <div
                                className="w-full max-w-md sm:w-2/3 lg:w-1/3 sm:my-5 my-8 relative z-10 bg-emerald-600 rounded-lg shadow-lg"
                            >
                                <div
                                    className="text-sm leading-none rounded-t-lg bg-emerald-800 text-white font-semibold uppercase py-4 text-center tracking-wide"
                                >
                                    Most Popular
                                </div>
                                <div
                                    className="block text-left text-sm sm:text-md max-w-sm mx-auto mt-2 text-white px-8 lg:px-6"
                                >
                                    <h1
                                        className="text-lg font-medium uppercase p-3 pb-0 text-center tracking-wide"
                                    >
                                ...
                                <div className="flex pl-12 justify-start sm:justify-start mt-3">
                                    <ul>
                                        <li className="flex items-center">
                                            ...
                                            <span className="text-white text-lg ml-3 p-2">Continuous updates on database</span>
                                        </li>
                                        <li className="flex items-center">
                                            <div
                                                className=" rounded-full p-2 fill-current text-green-700"
                                ...
                                <div className=" flex items-center p-8  uppercase">
                                    <button
                                        className="mt-3 text-lg font-semibold 
	bg-gray-300 w-full text-gray-800 rounded-lg 
	px-6 py-3 block shadow-xl hover:bg-emerald-500 hover:text-white"
                                    >
                                        Select
                                    </button>
