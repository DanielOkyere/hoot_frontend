export default function Pricecomponent() {
        ...
        <>
            <div>
                <div className="container max-w-full mx-auto py-24 px-6">
                    ...
                    <div
                        className="h-1 mx-auto bg-orange-500 w-24 opacity-75 mt-4 rounded"
                    ></div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        HOOT offers everything needed to run an online business
	...
	px-6 py-3 block shadow-xl hover:bg-gray-700 hover:text-white"
                            ...
                            <div
                                className="w-full max-w-md sm:w-2/3 lg:w-1/3 sm:my-5 my-8 relative z-10 bg-orange-500 rounded-lg shadow-lg"
                            >
                                <div
                                    className="text-sm leading-none rounded-t-lg bg-orange-500 text-white font-semibold uppercase py-4 text-center tracking-wide"
                                >
                                    Most Popular
                                </div>
                                <div
                                ...
                                >
                                    ...
                                    <h2 className="text-sm text-white text-center pb-6"><span className="text-3xl">$300</span> /mo</h2>

                                    Hoot offers everything needed to run an online business at
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <h2 className="text-sm text-gray-500 text-center pb-6">$ 999/mo</h2>
